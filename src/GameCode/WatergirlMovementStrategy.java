...
public class WatergirlMovementStrategy implements MovementStrategy {
    private Image image;
    ...
    public WatergirlMovementStrategy() {
        image = new ImageIcon("./Images/Watergirl.png").getImage();
        moveLeft = new MoveLeftCommand(Player.HorizontalSPEED + 2);
        moveRight = new MoveRightCommand(Player.HorizontalSPEED + 2);
        jump = new JumpCommand(Player.VerticalSPEED + 5);
